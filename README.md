About modflow2netcdf-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/modflow2netcdf-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3114&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/modflow2netcdf-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `modflow2netcdf` can be installed with `conda`:
...
```
mamba install modflow2netcdf
```

It is possible to list all of the versions of `modflow2netcdf` available on your platform with `conda`:
...
```
mamba search modflow2netcdf --channel conda-forge
```
...
mamba repoquery search modflow2netcdf --channel conda-forge

# List packages depending on `modflow2netcdf`:
mamba repoquery whoneeds modflow2netcdf --channel conda-forge

# List dependencies of `modflow2netcdf`:
mamba repoquery depends modflow2netcdf --channel conda-forge
```
